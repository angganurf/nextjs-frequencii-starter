				...
				<div className="flex flex-wrap -mx-4">
					<div className="w-full md:w-1/2 lg:w-5/12 px-4 mb-20 lg:mb-0">
						<div className="max-w-xs mb-10">
							<span className="inline-flex items-center h-6 mb-4 px-2 text-sm uppercase font-medium text-yellowGreen-700 bg-blue-200 rounded-full">
								Feature
							</span>
							...
							<p className="text-gray-700 mb-10">
								Increase your marketing team efficiency with a quick search and
								ease of use features.
							</p>
							<ul>
								<li className="flex mb-5 items-center">
									<div className="flex items-center justify-center w-8 h-8 mr-3 p-px rounded-full bg-gradient-to-br from-[#1a73e8] to-[#1765cc]">
					...
					<div className="w-full md:w-1/2 lg:w-7/12 px-4">
						<div>
							<div className="flex items-start max-w-xl mb-12">
								<div className="flex-shrink-0 flex items-center justify-center w-8 h-8 mr-6 p-px rounded-full bg-gradient-to-br from-[#1a73e8] to-[#1765cc]">
									<div className="flex items-center justify-center bg-white h-full w-full rounded-full">
										<svg
											width="16"
											height="16"
