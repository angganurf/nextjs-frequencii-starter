				...
				<div className="container px-4 mx-auto">
					<div className="max-w-3xl mx-auto text-center">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
							{/* WhatsApp Card */}
							<div className="bg-white rounded-2xl shadow-xl shadow-blue-900/5 border border-gray-100 p-8 hover:transform hover:-translate-y-1 transition-all duration-300">
